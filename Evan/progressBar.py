...
def train_cb():
    ...
    cb_model.fit(X_train, y_train, verbose=False, eval_set=(X_test, y_test), plot=False, logging_level='Silent', metric_period=1, custom_metric=['Accuracy'], task_type='CPU', random_seed=42, od_type='Iter', od_wait=10, callbacks=[on_iteration])
